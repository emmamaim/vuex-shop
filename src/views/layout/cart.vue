    ...
    <div v-if="isLogin && cartList.length > 0">
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-if="!isEdit" class="goPay" :class="{ disabled: selCount === 0 }" @click="goPay">結算({{ selCount }})</div>
          <div v-else class="delete" @click="handleDel" :class="{ disabled: selCount === 0 }">刪除</div>
        </div>
      </div>
    </div>
